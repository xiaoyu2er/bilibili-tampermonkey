// ==UserScript==
// @name         Bilibili
// @namespace    https://github.com/xiaoyu2er/bilibili-tampermonkey
// @version      0.0.1
...
(function () {
    'use strict';
    console.log('Hello from Bilibili Tampermonkey script! @0.0.1',);
    //XHook - v1.6.2 - https://github.com/jpillora/xhook
    //Jaime Pillora <dev@jpillora.com> - MIT Copyright 2023
    var xhook = (function (window) {
        'use strict';
    ...
    xhook.after(function (req, res) {
        ...
        const isFeedUrl = req.url.includes(`/x/polymer/web-dynamic/v1/feed/all`);
        if (isFeedUrl) {
            const json = JSON.parse(res.text);
            json.data.items = json.data.items.filter(item => {
                return item.type === 'DYNAMIC_TYPE_AV'
            });
